...
public class CreateContactwithCreatedTime {
	...
	public static void main(String[] args) throws Exception {
		...
		/*create time verification */
		String supportStartDateDisplayed = driver.findElement(By.id("dtlview_Support Start Date")).getText();
		String supportEndDateDisplayed = driver.findElement(By.id("dtlview_Support End Date")).getText();
		
		if(supportStartDateDisplayed.trim().equals(supportStartDate)) {
...
if(supportEndDateDisplayed.trim().equals(supportEndDate)) {
