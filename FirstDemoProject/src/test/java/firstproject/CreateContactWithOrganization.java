...
/*OBJECTS CREATION*/
	...
	String organizationNameDisplayed = driver.findElement(By.id("mouseArea_Organization Name")).getText();
		
		if(organizationNameDisplayed.trim().equals(ActualOrganizationName)) {
